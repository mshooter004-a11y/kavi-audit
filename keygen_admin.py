# keygen_admin.py
"""
Admin key generator for KaviAudit - creates 19-character keys with words and numbers.
"""
...
def create_license_file(key: str, private_key):
    ...
    with open("admin_license.kvl", "wb") as f:
...
def main():
    ...
    print("License file 'admin_license.kvl' created")
